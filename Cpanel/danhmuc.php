    ...
    <div class="be-wrapper be-fixed-sidebar">
        <nav class="navbar navbar-expand fixed-top be-top-header">
            <div class="container-fluid">
                ...
                <div class="page-title"><span>Danh mục</span></div>
            ...
            <div class="main-content container-fluid">
                ...
                <div class="col-md-4">
                            <div class="widget widget-head">
                                ...
                                </div><span class="title"><b>Thêm Danh mục</b></span>
                            </div>
                            <div class="card-body table-responsive">
                                ...
                                <form action="" method="post">
                                    <input type="text" name="iddm" id="iddm" style="display:none">
                                    <input type="text" name="tendanhmuc" id="tendanhmuc" placeholder="Tên danh mục" required>
                                    <div class="btnSlider">
                                        <button type="submit" name="themdm">Thêm danh mục</button>
                                        <button type="submit" name="updatedm">Update danh mục</button>
                                    </div>
                                    <?php
                        ...
                        <div class="col-md-8">
                            <div class="widget widget-fullwidth be-loading">
                                <div class="widget-head">
                                    ...
                                    <div class="button-toolbar d-none d-md-block">
                                    </div><span class="title"><b>Danh mục sản phẩm</b></span></div>
                                    <p style="color:red; text-align:center;">*Lưu ý xoá danh mục sẽ xoá tất cả sản phẩm thuộc danh mục đó</p>
