                            ...
                            <div class="table-responsive noSwipe">
                                ...
                                <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            <th style="width:4%;">
                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                    <input type="checkbox" onclick="selectChekboxAll();">
                                                </div>
                                            </th>
                                            <th style="width:20%;">Nội dung bình luận</th>
                                            <th style="width:17%;">Bài viết</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $masp = $_POST['chitiet'];
                                        view_quanly_cmt($masp);
                                        if (isset($_POST['btnXoacmt'])) {
                                            $idcmt = $_POST['btnXoacmt'];
                                            del_cmt($idcmt);
                                        }
                                        if (isset($_POST['btnxoaAll'])) {
                                            $conn = connect_db();
                                            if (isset($_POST['checkbox'])) {
                                                $checkbox = $_POST['checkbox'];
                                                foreach ($checkbox as $x) {
                                                    mysqli_query($conn, "DELETE FROM cmt where idcmt = $x");
                                                    echo $x. ' ';
                                                }
                                                header("Refresh:0");
                                            }
                                ...
                                <p style="text-align: center;margin: 20px;"><span class="btn1 csschon">Chọn tất cả</span>
                                <span class="btn2 csschon">bỏ chọn tất cả</span>
                                <button class="csschon2" type="submit" name="btnxoaAll">Xoá các mục đã chọn</button></p>
                                </form>
                            </div>
                        </div>
                    </div>
