    ...
    <a href="#s4">4</a>
            ...
            <div class="product-all">
                <div class="title-all" id="denphansanpham">
                    <form action="#denphansanpham" method="post">
                    <h2 id="title-all-product" <?php background_menu() ?>><button type="submit" name="tatca">Tất cả sản phấm</button></h2>
                    <h2 id="title-all-product" <?php background_menu() ?>><button type="submit" name="loai" value="Chính hãng">Sản phẩm chinh hãng</button></h2>
                    <h2 id="title-all-product" <?php background_menu() ?>><button type="submit" name="loai" value="Xách tay">Sản phẩm xách tay</button></h2>
                    </form>
        ...
        <footer>
            ...
            <div class="content-footer-down" <?php background_menu() ?>>
                <span id="mobile-sp">Copyright © <?php copyright(); ?></span>
                <span id="mobile-ok">©<?php copyright(); ?></span>
                <span>
                    <ul>
                        <li>Mạng xã hội:</li>
                        <?php social(); ?>
